...
//  cm
//
//  Created by kevin.zhang on 2017/5/24.
...
class CalendarManagerViewController: UIViewController {
    ...
    override func loadView() {
        ...
        let calendar = FSCalendar(frame: CGRect(x: 0, y: self.navigationController!.navigationBar.frame.maxY, width: kScreenW, height: height))
...
extension CalendarManagerViewController:FSCalendarDataSource, FSCalendarDelegate, FSCalendarDelegateAppearance {
    ...
    private func configure(cell: FSCalendarCell, for date: Date, at position: FSCalendarMonthPosition) {
        ...
        let diyCell = (cell as! CalendarManagerCell)
        // Custom today circle
